...
export default function CurrencyConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[url('')] bg-cover">
      <Card className="w-full max-w-md p-6 space-y-4 bg-slate-300 border-black bg-opacity-80">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-black">Currency Converter</CardTitle>
          <CardDescription className="text-black">Convert between different currencies.</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
        ...
        <CardFooter>
          <Button
            type="button"
            className="w-full bg-blue-600 text-white hover:bg-blue-950"
